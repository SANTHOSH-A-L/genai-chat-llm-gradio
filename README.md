...
#### STEP 2:
Load a Pre-Trained Model Use a pre-trained model like GPT-2 or DialoGPT from Hugging Face. Initialize the model using the pipeline API for straightforward interaction.
#### STEP 3:
...
```
### OUTPUT:
<img width="1055" height="432" alt="image" src="https://github.com/user-attachments/assets/cd9157e8-4f2e-4b97-964a-933c43380aa6" />
